...
/////////////////////////////////////code for sort product using dropdown//////////////////////////////
...
if(isset($_GET['sort']))
{
    ...
    // echo "the value of sort is : "."$sort";
    if($sort=='price_high')
    {
                    ...
                    <div class="htc__grid__top">
                        <div class="htc__select__option">
                            <select class="ht__select" onchange="sort_product_drop('<?php echo $cat_id ?>','<?php echo SITE_PATH ?>')" id="sort_product_id">
                                ...
                                <option value="new" <?php echo $new_selected ?>>Sort by new frist</option>
                                <option value="old" <?php echo $old_selected ?>>Sort by old frist</option>
                            </select>
                        </div>
